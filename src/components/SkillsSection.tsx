...
const SkillsSection = () => {
  ...
  return (
    <section id="skills" className="section-padding py-20 dark:bg-dark-800/50 bg-light-800/50">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8">
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              <h3 className="text-xl dark:text-white text-gray-900 mb-4">{category.title}</h3>

              <div className="flex flex-wrap gap-2">
                {category.skills.map((skill, skillIndex) => (
                  <span
                    key={skillIndex}
                    className="px-3 py-1.5 dark:bg-dark-700 bg-light-700 dark:text-gray-300 text-gray-700 rounded-md text-sm hover:bg-primary hover:text-white transition-colors"
                  >
                    {skill}
                  </span>
                ))}
              ...
              {category.note && (
                <p className="text-sm dark:text-gray-400 text-gray-500 mt-3 italic">
                  {category.note}
                </p>
              )}
            </div>
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="text-center">
            ...
            <div className="dark:text-gray-400 text-gray-500">Apps iOS</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-primary">7+</div>
            <div className="dark:text-gray-400 text-gray-500">Années d'expérience</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-primary">100%</div>
            <div className="dark:text-gray-400 text-gray-500">Autodidacte</div>
          </div>
          <div className="text-center">
            <div className="text-3xl font-bold text-primary">∞</div>
            <div className="dark:text-gray-400 text-gray-500">Curiosité</div>
          </div>
        </div>
      </div>
    </section>
