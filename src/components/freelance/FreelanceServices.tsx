    ...
    <section id="services" className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
            ...
            return (
              <div
                ...
                className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 ${
                  service.highlight ? 'border-2 border-blue-500 relative' : 'border border-gray-200'
                }`}
              >
                {service.highlight && (
                ...
                {service.badge && (
                  <div className="absolute -top-4 right-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-3 py-1 rounded-full text-xs font-semibold">
                    {service.badge}
                  </div>
                )}
        ...
        <div className="mt-16 text-center">
          ...
          <a
            href="#contact"
            className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold hover:shadow-2xl transition-all duration-300"
          >
