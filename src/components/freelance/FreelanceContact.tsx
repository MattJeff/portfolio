      ...
      <div className="max-w-7xl mx-auto section-padding">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-dark-800 rounded-2xl p-6 border border-dark-600 hover:border-primary transition-all duration-300">
            ...
            <div className="bg-dark-800 rounded-2xl p-6 border border-dark-600 hover:border-primary transition-all duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">Remote • Hybride • Sur site IDF</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center">
            ...
            {/* Availability */}
            <div className="mt-6 bg-green-900/20 border border-green-600/30 rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-3 h-3 bg-green-500 rounded-full animate-pulse" />
                <h4 className="font-bold text-white">Disponibilité actuelle</h4>
              </div>
              <p className="text-gray-300 text-sm">
                Je suis actuellement <strong className="text-green-400">disponible</strong> pour de nouveaux projets
