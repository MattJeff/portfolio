      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <div
              key={index}
              className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-200 relative"
            >
              {/* Quote Icon */}
              <div className="absolute -top-4 -left-4 bg-gradient-to-br from-blue-500 to-purple-600 w-12 h-12 rounded-full flex items-center justify-center shadow-lg">
              ...
              <div className="mt-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-3">
                <div className="text-xs text-gray-600 mb-1">Projet : {testimonial.project}</div>
                <div className="text-sm font-semibold text-gray-900">Budget : {testimonial.budget}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Stats */}
        <div className="mt-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl p-12 text-white text-center">
        ...
        <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
            <div className="text-3xl mb-2">🔒</div>
            <div className="font-semibold text-gray-900">NDA & Confidentialité</div>
          </div>
          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
            <div className="text-3xl mb-2">💬</div>
            <div className="font-semibold text-gray-900">Communication 24/7</div>
          </div>
          <div className="bg-white rounded-xl p-6 border border-gray-200 text-center">
            <div className="text-3xl mb-2">✅</div>
