...
export function PersonJsonLd() {
  const jsonLd = {
    ...
    '@type': 'Person',
    '@id': 'https://mathishiguinen.com/#person',
    name: 'Mathis Higuinen',
    givenName: 'Mathis',
    familyName: 'Higuinen',
    url: 'https://mathishiguinen.com',
    image: 'https://mathishiguinen.com/images/mathis-higuinen.jpg',
...
export function WebSiteJsonLd() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebSite',
    '@id': 'https://mathishiguinen.com/#website',
    url: 'https://mathishiguinen.com',
    ...
    potentialAction: {
      ...
      target: {
        '@type': 'EntryPoint',
        urlTemplate: 'https://mathishiguinen.com/?s={search_term_string}',
      },
...
export function ProfessionalServiceJsonLd() {
  const jsonLd = {
    ...
    '@id': 'https://mathishiguinen.com/#service',
    ...
    image: 'https://mathishiguinen.com/images/og-image.png',
    telephone: '+33674578668',
    email: 'mhiguinen235@gmail.com',
    priceRange: '€€',
    address: {
...
export function ProjectJsonLd({ title, description, url, image, technologies, dateCreated }: ProjectJsonLdProps) {
  const jsonLd = {
    ...
    url: url,
    image: image || 'https://mathishiguinen.com/images/og-image.png',
